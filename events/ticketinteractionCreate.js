...
module.exports = {
    ...
    async execute(interaction) {
        const logChannelId = '1268251301301588043'; // Log channel ID
        ...
        try {
            if (interaction.isStringSelectMenu()) {
                ...
                if (interaction.customId === 'ticket_select') {
                    ...
                    const generalStaffRoleId = '1263673501382869089'; 
                    const staffReportRoleId = '1263700078695157790'; 
                ...
                if (interaction.customId === 'claim_ticket') {
                    const staffRoleId = '1263673501382869089'; 
                    const staffReportRoleId = '1263700078695157790'; 
